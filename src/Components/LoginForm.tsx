  ...
  return (
    <>
        <div>
            ...
            <div><p className="text-center m-3 italic text-slate-500">Don't have an account? <Link to={"/signup"}><span className="font-semibold hover:text-teal-500">Sign Up</span></Link></p></div>
          </div>
    </>
  )
}
